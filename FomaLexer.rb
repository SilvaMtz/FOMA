...
module Foma
  ...
  class Lexer < ANTLR3::Lexer
    ...
    # - - - - label initialization - - - -
      ...
      # - - - - main rule block - - - -
      # at line 101:5: ( 'a' .. 'z' | 'A' .. 'Z' ) ( ( 'a' .. 'z' | 'A' .. 'Z' ) | '_' | ( '0' .. '9' ) )*
